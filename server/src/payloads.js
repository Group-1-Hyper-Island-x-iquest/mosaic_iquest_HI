...
const requests = [
  ...
  {
    type: "",
    action: "LOAD_CONNECTION_TYPE",
    connectionType: "se.iquest.iqmine.connections.SMHIConnection",
  },
  {
    type: "MineService",
    ...
    connection: {
      ...
      allowedExplorers: ["SMHI"],
      version: "V2",
      forecastLength: 10,
      locations: [
        {
          site: "Seminariet",
          street: "PrÃstgatan 26",
          city: "Uppsala",
          country: "Sweden",
          lat: "59.8686687",
          lon: "17.6180381",
...
const responses = [
  {
    ...
    payload: [
      ...
      },
      {
        ...
        address: "fdasabino@gmail.com",
        port: 0,
        forecastLength: 10,
        name: "elvaco",
        explorer: "se.iquest.iqmine.explorers.SMHIExplorer",
        description: "A very nice service",
        locations: [
          {
            country: "Sweden",
            site: "Hildebrandsvagen 20A",
            city: "Stockholm",
            street: "Hildebrandsvagen 20A",
            lon: "12,64654645",
            lat: "65,3566464",
          },
        ],
      ...
      {
        password: "",
        address: "connectiondsölffkedsfeösjewflk",
        port: 0,
        forecastLength: 10,
        name: "smhi1",
        explorer: "se.iquest.iqmine.explorers.SMHIExplorer",
...
const createJobResponse = (data) => {
  return {
    ...
    payload: {
      ...
      tags: [
        {
          values: ["percent", "category", "kg/m2/h", "octas", "Cel", "hPa", "km", "degree", "m/s"],
          type: "@unit",
        },
        {
          values: [
